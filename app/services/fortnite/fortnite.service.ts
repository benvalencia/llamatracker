...
export class FortniteService {
  ...
  private fortniteApiIOClient = new FortniteAPI(this.ApiConfig() as ClientConfig).v2
   ...
   */
  private ApiConfig(client?: boolean): string | ClientOptions {
    const fortniteApiConfig: string = "cdea95c0-f20fbd17-1d88e5b9-1b216e0e";
